...
class LazyMinter {
  ...
  async createVoucher(tokenId, name, level, experience, image, tp, description, attack1, attack2, attack3, attack4) {
    ...
    const description32 = ethers.utils.formatBytes32String(description);
    ...
    const voucher = { 
      tokenId, 
      image,
      data: [name32, description32, type32, attack1_32, attack2_32, attack3_32, attack4_32],
